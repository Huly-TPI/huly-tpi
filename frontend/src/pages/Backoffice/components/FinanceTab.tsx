  ...
  return (
    <div className="flex flex-col gap-6 animate-fadeIn lg:flex-grow lg:min-h-0">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 shrink-0">
        ...
        <div className="bg-gradient-to-br from-emerald-500/10 to-emerald-500/5 dark:from-emerald-950/20 dark:to-transparent border border-emerald-500/20 rounded-xl p-4 flex flex-col justify-between">
