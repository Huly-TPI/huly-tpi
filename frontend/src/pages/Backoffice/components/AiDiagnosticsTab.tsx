        ...
        <div className="bg-gray-55/50 dark:bg-[#09111f]/40 border border-gray-100 dark:border-gray-800/40 rounded-xl p-5 flex flex-col justify-between">
          <div>
            ...
            <div className="space-y-3 pt-2 border-t border-gray-100 dark:border-gray-800/40">
              <div>
                <span className="text-[12px] font-bold text-gray-400 uppercase tracking-wider block mb-1">Suele Aceptar:</span>
              ...
              <div className="pt-1">
                <span className="text-[12px] font-bold text-gray-400 uppercase tracking-wider block mb-1">Suele Ignorar/Rechazar:</span>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white dark:bg-[#172033] p-3.5 rounded-xl border border-gray-100 dark:border-gray-800/60 shadow-sm flex flex-col gap-1">
                <span className="text-[11px] font-bold text-gray-400 dark:text-gray-555 uppercase tracking-wider">Apodo Deseado</span>
                <span className="text-sm font-extrabold text-gray-750 dark:text-gray-200">
                  {aiDiagnostics.preferredName || 'sin nombre'}
                </span>
              </div>
              <div className="bg-white dark:bg-[#172033] p-3.5 rounded-xl border border-gray-100 dark:border-gray-800/60 shadow-sm flex flex-col gap-1">
                <span className="text-[11px] font-bold text-gray-400 dark:text-gray-555 uppercase tracking-wider">Tono del Chatbot</span>
                <span className="text-sm font-extrabold text-gray-750 dark:text-gray-200">
