    ...
    <div className="flex flex-col gap-4">
      <div className="flex items-start justify-between gap-3">
        <div className="flex flex-col gap-1">
          <h1 className="text-[30px] font-extrabold leading-tight text-[#8869AC]">Suscripciones</h1>
          <p className="text-[16px] text-[#A0AEC0]">Precios y configuración de los planes</p>
        </div>
