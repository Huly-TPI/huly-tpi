...
import lanternImage from '../../assets/lanterns/ligth-theme/lanterns.webp'
...
const BG_POSITIONS = [
  { top: '5%',  left: '60%', size: 'w-[22%] md:w-[14%]', floatClass: 'lantern-float-1' },  // arriba derecha
  { top: '2%',  left: '78%', size: 'w-[18%] md:w-[12%]', floatClass: 'lantern-float-2' },  // arriba extremo derecha
  { top: '35%', left: '72%', size: 'w-[20%] md:w-[13%]', floatClass: 'lantern-float-3' },  // medio derecha
  { top: '47%', left: '85%', size: 'w-[16%] md:w-[10%]', floatClass: 'lantern-float-4' },  // bajo derecha
] as const
...
export default function LanternsActivity() {
  ...
  return (
    <div
      className="lanterns-page relative flex h-full flex-col overflow-hidden"
      ...
      {mainLantern && (
        ...
        >
          <div className="relative">
            ...
            <div className="lantern-text absolute inset-0 flex items-center justify-center px-[22%] pb-[18%] pt-[12%]">
              <p className="text-center font-nunito text-xs font-semibold leading-tight text-[#5a3e28] md:text-sm lg:text-base">
                {mainLantern.text}
              </p>
            </div>
          </div>
