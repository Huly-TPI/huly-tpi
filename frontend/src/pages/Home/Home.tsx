import backgroundImage from '../../assets/garden/light-theme/background/day-background.webp'
...
const createCloudElement = (
  ...
  imageAlt: 'Nube del jardín para respiraciones guiadas',
...
const gardenElements: SceneElementDefinition[] = [
  {
    id: 'tree',
    title: 'Minijuegos',
    imageAlt: 'Árbol con hamaca en el jardín',
    image: { light: treeImage },
  ...
  },
  {
    id: 'house',
    title: 'Perfil',
    imageAlt: 'Casa con forma de hongo en el jardín',
    image: { light: houseImage },
  ...
  },
  {
    id: 'todo-board',
    title: 'Pendientes',
    imageAlt: 'Cartel de pendientes en el jardín',
    image: { light: todoBoardImage },
  ...
  },
  {
    id: 'watering-can',
    title: 'Retos',
    imageAlt: 'Regadera y maceta en el jardín',
    image: { light: wateringCanImage },
  ...
  },
  {
    id: 'notebook',
    title: 'Diario',
    imageAlt: 'Banco con cuaderno en el jardín',
    image: { light: notebookImage },
...
const sceneTheme: SceneTheme = 'light'
  ...
  return (
    <main className="garden-page">
      <section className="garden-scene">
        <img
          src={backgroundImage}
          alt="Fondo diurno del jardín"
          className="garden-scene__background pointer-events-none select-none"
        />
