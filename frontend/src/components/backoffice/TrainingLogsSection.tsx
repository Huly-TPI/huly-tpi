      ...
      {loading ? (
        <div className="overflow-x-auto">
          <table className="w-full min-w-[480px]">
            <thead>
              <tr className="border-b border-gray-100 dark:border-gray-800 text-left text-[11px] font-semibold uppercase tracking-wide text-gray-400 dark:text-gray-500">
              ...
              {logs.map((log, i) => (
                <tr key={i}>
                  ...
                  <td className="py-3 pr-4">
                    <span className={`inline-block w-24 text-center rounded-full py-0.5 text-xs font-semibold ${EMOTION_CLS[log.emotion] ?? 'bg-gray-100 text-gray-600 dark:bg-gray-800 dark:text-gray-300'}`}>
                      {log.emotion}
                    </span>
                  </td>
                  ...
                  <td className="py-3">
                    <div className="flex gap-2">
                      <button className="rounded-lg p-1 text-bosque hover:bg-green-50 dark:hover:bg-green-950/20 transition-colors">
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                        </svg>
                      </button>
                      <button className="rounded-lg p-1 text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors">
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
