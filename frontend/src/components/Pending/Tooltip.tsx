    ...
    >
      ...
      {coords &&
        createPortal(
          <span
            role="tooltip"
            className={`pointer-events-none fixed z-[9999] -translate-y-full rounded-md bg-[#3b2510] px-2 py-1 text-[0.65rem] font-medium text-[#fff8e7] shadow-[0_4px_10px_rgba(0,0,0,0.25)] ${
