...
class GrantBadgeUseCaseTest {
    ...
    @BeforeEach
    void setUp() {
        grantBadgeUseCase = new GrantBadgeUseCase(badgeRepository, userBadgeRepository, userRepository, new GrantBadgeMapper());
    ...
    void execute_shouldGrantBadgeToUser_whenUserAndBadgeExistAndUserDoesNotHaveBadge() {
        ...
        grantBadgeUseCase.execute(new GrantBadgeRequest("user@huly.com", "PRIMER_PASO"));
    ...
    void execute_shouldThrowNotFoundException_whenUserDoesNotExist() {
        ...
        assertThatThrownBy(() -> grantBadgeUseCase.execute(new GrantBadgeRequest("noexiste@huly.com", "PRIMER_PASO"))).isInstanceOf(NotFoundException.class);
    }
    ...
    assertThatThrownBy(() -> grantBadgeUseCase.execute(new GrantBadgeRequest("user@huly.com", "INEXISTENTE"))).isInstanceOf(NotFoundException.class);
    }
