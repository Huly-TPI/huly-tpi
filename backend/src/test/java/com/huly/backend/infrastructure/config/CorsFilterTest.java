...
class CorsFilterTest {
    ...
    @Test
    void doFilter_shouldReturn200WithCorsHeaders_whenOptionsRequestFromLandingUrl() throws ServletException, IOException {
        request.setRequestURI("/api/leads");
        request.setMethod("OPTIONS");
        request.addHeader("Origin", LANDING_URL);
    ...
    @Test
    void doFilter_shouldPassThroughWithCorsHeaders_whenRegularRequestFromLandingUrl() throws ServletException, IOException {
        request.setRequestURI("/api/leads");
        request.setMethod("POST");
        request.addHeader("Origin", LANDING_URL);
