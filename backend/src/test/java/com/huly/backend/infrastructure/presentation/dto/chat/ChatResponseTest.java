...
class ChatResponseTest {
    ...
    void chatResponse_shouldCreateWithAllFields() {
        ...
        ChatResponse response = new ChatResponse("todo bien", "JOY", 8, action, challenge, metadata, null, null, null, null);
    ...
    void chatResponse_shouldHandleNullOptionalFields() {
        ChatResponse response = new ChatResponse("respuesta", null, null, null, null, null, null, null, null, null);
