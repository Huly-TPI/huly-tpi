ALTER TABLE product ADD COLUMN coins_amount INTEGER NOT NULL DEFAULT 0;
...
CREATE INDEX idx_payment_event_mp_preference_id ON payment_event(mp_preference_id);
CREATE INDEX idx_payment_event_mp_payment_id    ON payment_event(mp_payment_id);
